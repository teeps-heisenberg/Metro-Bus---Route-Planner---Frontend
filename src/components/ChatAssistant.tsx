...
const ChatAssistant: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-teal-600 mb-2">AI Travel Assistant</h1>
        <p className="text-gray-600">Chat with our AI conductor for travel guidance and route planning</p>
      </div>

      <div className="card flex flex-col lg:flex-row gap-6 h-[600px] min-h-[400px] relative border rounded-xl shadow-md overflow-hidden" aria-busy={loading}>
